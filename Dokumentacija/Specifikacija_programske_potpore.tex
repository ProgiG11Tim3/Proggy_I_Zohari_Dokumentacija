\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\noindent \underbar{\textbf{UC12 - Pregled pacijenata u sustavu}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Nakon prijave u sustav odmah se otvara sučelje s popisom svih pacijenata
					...
					\noindent \underbar{\textbf{UC13 - Pregled podataka pacijenta}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Otvara se prikaz profila tog pacijenta s osobnim podacima, opcijom za otvaranje medicinskog kartona tog pacijenta, te opcijom za unos novog pregleda
						\end{packed_enum}
					\end{packed_item}
					
					\noindent \underbar{\textbf{UC14 - Otvaranje kartona pacijenta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC15 - Unos novog pregleda}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Liječnik unosi podatke o pregledu, te pritišće opciju za unos
						\end{packed_enum}
					\end{packed_item}
					
					
					\noindent \underbar{\textbf{UC16 - Generiranje ispričnice}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC17 - Generiranje preporuke o bolovanju}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC18 - Slanje obavijesti roditelju}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC19 - Specijalistički pregledi}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Pedijatar na profilu pacijenta bira opciju "Specijalistički pregled"
					...
					\noindent \underbar{\textbf{UC20 - Pregled nalaza iz privatnih ustanova}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC21 - Povratna informacija na nalaz}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC22 - Unos novog pacijenta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC23 - Potvrda preporuka za bolovanje}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC24 - Stvaranje profila liječnika/pedijatra}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC25 - Pregled korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC26 - Odabir korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC27 - Brisanje korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC28 - Promjena podataka korisnika}}
					\begin{packed_item}
