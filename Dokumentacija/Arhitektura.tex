\chapter{Arhitektura i dizajn sustava}
		...
		\section{Baza podataka}
			...
			\subsection{Opis tablica}
				...
				\textbf{Specijalistički pregled} - Entitet sadržava podatke koji opisuju specijalistički pregled na kojeg liječnik/pedijatar prijavljuje pacijenta. Oni su: šifra pregleda, šifra pacijenta, naziv pregleda, moguće lokacije pregleda. Entitet Spec. pregled u odnosu je \textit{Many-to-One} s entitetima Roditelj i Dijete.
				...
				\begin{longtblr}[
					...
					\hline \SetCell[c=3]{c}{\textbf{Specialist examination/Specijalistički pregled}}	 \\ \hline[3pt]
					\SetCell{LightGreen}examId & INT	&  	Jedinstveni identifikator pregleda	\\ \hline
					\SetCell{LightBlue}patientOib	& CHAR(11) &  Jedinstveni identifikator pacijenta 	\\ \hline 
					examTitle & VARCHAR &  Naziv pregleda  \\ \hline 
					examLocations & VARCHAR	&  	Moguće lokacije pregleda	\\ \hline
				\end{longtblr}
				
				\textbf{Preporuka o bolovanju} - Entitet sadržava podatke o bolovanju kojeg pedijatar preporučuje za roditelja djeteta. Oni su: šifra preporuke, šifra liječnika obiteljske medicine, opis razloga za bolovanje i trajanja. Entitet Prep. o bolovanju u odnosu je \textit{Many-to-One} s entitetom Liječnik obiteljske medicine.
				...
				\begin{longtblr}[
					...
					\hline \SetCell[c=3]{c}{\textbf{Sick leave recommendation/Preporuka o bolovanju}}	 \\ \hline[3pt]
