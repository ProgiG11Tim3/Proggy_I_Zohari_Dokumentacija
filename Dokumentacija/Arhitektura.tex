\chapter{Arhitektura i dizajn sustava}
		...
		\section{Baza podataka}
			...
			\subsection{Opis tablica}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue}parentId	& INT &  Jedinstveni identifikator liječnika	\\ \hline 
				...
				\textbf{Lokacija bolnice} - Entitet sadržava podatke o bolnicama unutar Republike Hrvatske. Oni su: šifra bolnice, adresa, lokacija, ime bolnice, x i y koordinate bolnice na karti. Entitet Bolnica u odnosu je \textit{Many-to-Many} s entitetom Specijalistički pregled.
				...
				\begin{longtblr}[
					...
					\hline \SetCell[c=3]{c}{\textbf{HospitalLocation/Lokacija bolnice}}	 \\ \hline[3pt]
					\SetCell{LightGreen}hosLocationId & INT	&  	Jedinstveni identifikator bolnice	\\ \hline
				...
				\begin{longtblr}[
					...
					\hline \SetCell[c=3]{c}{\textbf{Lokacija pregleda/ExamLocation}}	 \\ \hline[3pt]
					\SetCell{LightGreen}hosLocationId & INT	&  	Jedinstveni identifikator bolnice	\\ \hline
					\SetCell{LightGreen}examId & INT	&  	Jedinstveni identifikator pregleda	\\ \hline
				\end{longtblr}
				
				\textbf{Datoteka} - Entitet koji pohranjuje PDF datoteke koje roditelj \textit{uploada} prilikom slanja privatnog nalaza liječniku/pedijatru. Entitet je u vezi \textit{Many-to-One} s entitetom Nalaz.
				\begin{longtblr}[
					label=none,
					entry=none
					]{
					...
					\hline \SetCell[c=3]{c}{\textbf{File/Datoteka}}	 \\ \hline[3pt]
					\SetCell{LightGreen}fileId & VARCHAR	&  	Jedinstveni identifikator datoteke	\\ \hline
					...
					\SetCell{LightBlue}reportId & INT & Ostvaruje vezu s Nalazom\\ \hline
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\hline \SetCell[c=3]{c}{\textbf{Sjednica/Session}}	 \\ \hline[3pt]
					\SetCell{LightGreen}loginSessionId & INT	&  	Jedinstveni identifikator sjednice	\\ \hline
			...
			\subsection{Dijagrami baze podataka}
				%unos slike
				\begin{figure}[H]
					\includegraphics[scale=0.5]{dijagrami/ozdraviER.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
				...
				%unos slike
				\begin{figure}[H]
					\includegraphics[scale=0.35]{dijagrami/ozdraviREL.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
					\caption{Dijagram arhitekture baze podataka}
		...
		\section{Dijagram razreda}
			...
			%unos slike
			\begin{figure}[H]
				\includegraphics[scale=0.0925]{dijagrami/dijraz1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			%unos slike
			\begin{figure}[H]
				\includegraphics[scale=0.1]{dijagrami/dijraz3.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			%unos slike
			\begin{figure}[H]
				\includegraphics[scale=0.225]{dijagrami/dijraz4.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
